...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [[
            'source','drafts','undo', 'redo','selectall', 'cleardoc', 'pasteplain','|','print','|',
            'rowspacingtop', 'rowspacingbottom', 'lineheight', 'indent', '|',
            'justifyleft', 'justifycenter',   'justifyright', 'justifyjustify', '|', 'touppercase', 'tolowercase', '|','horizontal','inserttable','insertcode'
        ],[
